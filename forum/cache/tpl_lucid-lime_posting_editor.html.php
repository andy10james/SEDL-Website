...
<fieldset class="fields1">
	...
	<dl>
		...
		<dd>
			<label for="icon"><input type="radio" name="icon" id="icon" value="0" checked="checked" /> <?php if ($this->_rootref['S_SHOW_TOPIC_ICONS']) {  ?><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_NO_TOPIC_ICON'])) ? $this->_rootref['L_NO_TOPIC_ICON'] : ((isset($user->lang['NO_TOPIC_ICON'])) ? $user->lang['NO_TOPIC_ICON'] : '{ NO_TOPIC_ICON }')); ?></span><?php } else { ?><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_NO_PM_ICON'])) ? $this->_rootref['L_NO_PM_ICON'] : ((isset($user->lang['NO_PM_ICON'])) ? $user->lang['NO_PM_ICON'] : '{ NO_PM_ICON }')); ?></span><?php } ?></label>
	...
	<div class="panel bg3" id="options-panel">
		...
		<fieldset class="fields1">
			...
			<dl>
				...
				<dd><?php $_topic_type_count = (isset($this->_tpldata['topic_type'])) ? sizeof($this->_tpldata['topic_type']) : 0;if ($_topic_type_count) {for ($_topic_type_i = 0; $_topic_type_i < $_topic_type_count; ++$_topic_type_i){$_topic_type_val = &$this->_tpldata['topic_type'][$_topic_type_i]; ?><label for="topic_type-<?php echo $_topic_type_val['VALUE']; ?>"><input type="radio" name="topic_type" id="topic_type-<?php echo $_topic_type_val['VALUE']; ?>" value="<?php echo $_topic_type_val['VALUE']; ?>"<?php echo $_topic_type_val['S_CHECKED']; ?> /><span style="color:#CCC;"><?php echo $_topic_type_val['L_TOPIC_TYPE']; ?></span></label> <?php }} ?></dd>
			</dl>
