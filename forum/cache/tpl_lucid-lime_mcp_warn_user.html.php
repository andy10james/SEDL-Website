...
<div class="panel">
	...
	<fieldset>
		...
		<dl class="panel">
			<dt>&nbsp;</dt>
			<dd><label><input type="checkbox" name="notify_user" checked="checked" /><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_NOTIFY_USER_WARN'])) ? $this->_rootref['L_NOTIFY_USER_WARN'] : ((isset($user->lang['NOTIFY_USER_WARN'])) ? $user->lang['NOTIFY_USER_WARN'] : '{ NOTIFY_USER_WARN }')); ?></span></label></dd>
		</dl>
		<?php } ?>
