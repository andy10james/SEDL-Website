...
<div class="panel">
	...
	<dl>
		...
		<dd>
			<label for="viewemail1"><input type="radio" name="viewemail" id="viewemail1" value="1"<?php if ($this->_rootref['S_VIEW_EMAIL']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span></label> 
			<label for="viewemail0"><input type="radio" name="viewemail" id="viewemail0" value="0"<?php if (! $this->_rootref['S_VIEW_EMAIL']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></label>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<label for="massemail1"><input type="radio" name="massemail" id="massemail1" value="1"<?php if ($this->_rootref['S_MASS_EMAIL']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span></label> 
			<label for="massemail0"><input type="radio" name="massemail" id="massemail0" value="0"<?php if (! $this->_rootref['S_MASS_EMAIL']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></label>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<label for="allowpm1"><input type="radio" name="allowpm" id="allowpm1" value="1"<?php if ($this->_rootref['S_ALLOW_PM']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span></label> 
			<label for="allowpm0"><input type="radio" name="allowpm" id="allowpm0" value="0"<?php if (! $this->_rootref['S_ALLOW_PM']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></label>
		</dd>
	</dl>
	<?php if ($this->_rootref['S_CAN_HIDE_ONLINE']) {  ?>
		...
		<dl>
			...
			<dd>
				<label for="hideonline1"><input type="radio" name="hideonline" id="hideonline1" value="1"<?php if ($this->_rootref['S_HIDE_ONLINE']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span></label> 
				<label for="hideonline0"><input type="radio" name="hideonline" id="hideonline0" value="0"<?php if (! $this->_rootref['S_HIDE_ONLINE']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></label>
			</dd>
		</dl>
	...
	<dl>
		...
		<dd>
			<label for="notifypm1"><input type="radio" name="notifypm" id="notifypm1" value="1"<?php if ($this->_rootref['S_NOTIFY_PM']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span></label> 
			<label for="notifypm0"><input type="radio" name="notifypm" id="notifypm0" value="0"<?php if (! $this->_rootref['S_NOTIFY_PM']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></label>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<label for="popuppm1"><input type="radio" name="popuppm" id="popuppm1" value="1"<?php if ($this->_rootref['S_POPUP_PM']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span></label> 
			<label for="popuppm0"><input type="radio" name="popuppm" id="popuppm0" value="0"<?php if (! $this->_rootref['S_POPUP_PM']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></label>
		</dd>
	</dl>
	<dl>
	...
	<dl>
		...
		<dd>
			<label for="dst1"><input type="radio" name="dst" id="dst1" value="1"<?php if ($this->_rootref['S_DST']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span></label> 
			<label for="dst0"><input type="radio" name="dst" id="dst0" value="0"<?php if (! $this->_rootref['S_DST']) {  ?> checked="checked"<?php } ?> /><span style="color:#CCC;"> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></label>
		</dd>
	</dl>
	<dl>
