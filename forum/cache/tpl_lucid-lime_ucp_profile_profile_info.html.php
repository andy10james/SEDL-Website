...
<div class="panel">
	...
	<?php if ($this->_rootref['S_BIRTHDAYS_ENABLED']) {  ?>
		...
		<dl>
			...
			<dd>
				<label for="bday_day"><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_DAY'])) ? $this->_rootref['L_DAY'] : ((isset($user->lang['DAY'])) ? $user->lang['DAY'] : '{ DAY }')); ?>: </span><select name="bday_day" id="bday_day" style="width: 4em;"><?php echo (isset($this->_rootref['S_BIRTHDAY_DAY_OPTIONS'])) ? $this->_rootref['S_BIRTHDAY_DAY_OPTIONS'] : ''; ?></select></label> 
				<label for="bday_month"><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_MONTH'])) ? $this->_rootref['L_MONTH'] : ((isset($user->lang['MONTH'])) ? $user->lang['MONTH'] : '{ MONTH }')); ?>: </span><select name="bday_month" id="bday_month" style="width: 4em;"><?php echo (isset($this->_rootref['S_BIRTHDAY_MONTH_OPTIONS'])) ? $this->_rootref['S_BIRTHDAY_MONTH_OPTIONS'] : ''; ?></select></label> 
				<label for="bday_year"><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_YEAR'])) ? $this->_rootref['L_YEAR'] : ((isset($user->lang['YEAR'])) ? $user->lang['YEAR'] : '{ YEAR }')); ?>: </span><select name="bday_year" id="bday_year" style="width: 6em;"><?php echo (isset($this->_rootref['S_BIRTHDAY_YEAR_OPTIONS'])) ? $this->_rootref['S_BIRTHDAY_YEAR_OPTIONS'] : ''; ?></select></label>
			</dd>
		</dl>
