...
<div class="panel">
	...
	<?php if ($this->_rootref['S_FOLDER_OPTIONS']) {  ?><hr class="dashed" /><?php } } if ($this->_rootref['S_FOLDER_OPTIONS']) {  ?>
		...
		<dl>
			...
			<dd style="margin-top: 3px;"><label for="remove_action1"><input type="radio" name="remove_action" id="remove_action1" value="1" checked="checked" /><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_MOVE_DELETED_MESSAGES_TO'])) ? $this->_rootref['L_MOVE_DELETED_MESSAGES_TO'] : ((isset($user->lang['MOVE_DELETED_MESSAGES_TO'])) ? $user->lang['MOVE_DELETED_MESSAGES_TO'] : '{ MOVE_DELETED_MESSAGES_TO }')); ?>:</span></label> <select name="move_to"><?php echo (isset($this->_rootref['S_TO_FOLDER_OPTIONS'])) ? $this->_rootref['S_TO_FOLDER_OPTIONS'] : ''; ?></select></dd>
			<dd style="margin-top: 3px;"><label for="remove_action2"><input type="radio" name="remove_action" id="remove_action2" value="2" /><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_DELETE_MESSAGES_IN_FOLDER'])) ? $this->_rootref['L_DELETE_MESSAGES_IN_FOLDER'] : ((isset($user->lang['DELETE_MESSAGES_IN_FOLDER'])) ? $user->lang['DELETE_MESSAGES_IN_FOLDER'] : '{ DELETE_MESSAGES_IN_FOLDER }')); ?></span></label></dd>
	...
	<dl>
		...
		<dd style="margin-top: 3px;"><label for="full_action1"><input type="radio" name="full_action" id="full_action1" value="1"<?php echo (isset($this->_rootref['S_DELETE_CHECKED'])) ? $this->_rootref['S_DELETE_CHECKED'] : ''; ?> /><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_DELETE_OLDEST_MESSAGES'])) ? $this->_rootref['L_DELETE_OLDEST_MESSAGES'] : ((isset($user->lang['DELETE_OLDEST_MESSAGES'])) ? $user->lang['DELETE_OLDEST_MESSAGES'] : '{ DELETE_OLDEST_MESSAGES }')); ?></span></label></dd>
		<dd style="margin-top: 3px;"><label for="full_action2"><input type="radio" name="full_action" id="full_action2" value="2"<?php echo (isset($this->_rootref['S_MOVE_CHECKED'])) ? $this->_rootref['S_MOVE_CHECKED'] : ''; ?> /><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_MOVE_TO_FOLDER'])) ? $this->_rootref['L_MOVE_TO_FOLDER'] : ((isset($user->lang['MOVE_TO_FOLDER'])) ? $user->lang['MOVE_TO_FOLDER'] : '{ MOVE_TO_FOLDER }')); ?>:</span></label> <select name="full_move_to"><?php echo (isset($this->_rootref['S_FULL_FOLDER_OPTIONS'])) ? $this->_rootref['S_FULL_FOLDER_OPTIONS'] : ''; ?></select></dd>
		<dd style="margin-top: 3px;"><label for="full_action3" style="white-space:normal;"><input type="radio" name="full_action" id="full_action3" value="3"<?php echo (isset($this->_rootref['S_HOLD_CHECKED'])) ? $this->_rootref['S_HOLD_CHECKED'] : ''; ?> /><span style="color:#CCC;"><?php echo ((isset($this->_rootref['L_HOLD_NEW_MESSAGES'])) ? $this->_rootref['L_HOLD_NEW_MESSAGES'] : ((isset($user->lang['HOLD_NEW_MESSAGES'])) ? $user->lang['HOLD_NEW_MESSAGES'] : '{ HOLD_NEW_MESSAGES }')); ?></span></label></dd>
	</dl>
