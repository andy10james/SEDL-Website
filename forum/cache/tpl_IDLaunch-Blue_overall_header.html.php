...
<div id="menu_bar">
	<div class="wrapper_menu">	
		<ul id="menu_nav">
			<li <?php if ($this->_rootref['SCRIPT_NAME'] == ('index') || $this->_rootref['SCRIPT_NAME'] == ('viewforum') || $this->_rootref['SCRIPT_NAME'] == ('viewtopic') || $this->_rootref['SCRIPT_NAME'] == ('viewonline') || $this->_rootref['SCRIPT_NAME'] == ('ucp') || $this->_rootref['SCRIPT_NAME'] == ('mcp')) {  ?> class="chosen" <?php } ?>><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></a></li>
			...
			<li><a href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>"><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></a></li><?php } ?>
	...
	<div class="wrapper_forum">
		...
		<div id="body_shadow_right">
			<div id="body_shadow_left">
				<div id="mainbody">
					<ul class="linklist">
						<li class="rightside"><?php if ($this->_rootref['S_USER_LOGGED_IN']) {  echo (isset($this->_rootref['LAST_VISIT_DATE'])) ? $this->_rootref['LAST_VISIT_DATE'] : ''; } else { echo (isset($this->_rootref['CURRENT_TIME'])) ? $this->_rootref['CURRENT_TIME'] : ''; } ?> &bull; <?php echo (isset($this->_rootref['S_TIMEZONE'])) ? $this->_rootref['S_TIMEZONE'] : ''; ?> </li>
					</ul>
